...
export const updateSpecificProperty= async (payload) => {
  return axios
    .post(BASE_ENDPOINT+'/post/updateproperty', payload, {
      headers: HEADERS.AUTHENTIC(),
    })
    .then(function (response) {
      if (response.status === 200) {
...
export const requestForCallBack = async (payload) => {
  return axios
    .post(BASE_ENDPOINT+'/post/requestCallBack', payload, {
      headers: HEADERS.AUTHENTIC(),
    })
    .then(function (response) {
      if (response.status === 200) {
