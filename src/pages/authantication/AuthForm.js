  ...
  return (
    <Grid>
      ...
      {isSigninForm && (
        <Card sx={{ mt: '20px' }}>
          <CardContent>
            <Typography fontWeight={'600'}>Welcome! Please authorize to begin the journey.</Typography>
          ...
          <CardContent>
            ...
            <Box component="form" noValidate mt={3} onSubmit={() => {}}>
              ...
              <FormControl variant="standard" fullWidth sx={{ mt: 1 }}>
                ...
                <Input  name='mobile' onChange={handleChange} autoComplete="mobile" required  htmlAttributes={{ type: 'tele' }} />
              </FormControl>
